...
<html lang="en">
<head>
    <link rel="stylesheet" href="https://r.offer.store/success/success/success.css">
    <title>Success!</title>
    <meta charset="UTF-8">
...
<img height="1" width="1" src="https://www.facebook.com/tr?id=1872050313017058&ev=Lead&noscript=1"/>
...
<div class="wrap">
    ...
    <div class="step1 step2">
        ...
        <h2 class="step1__subtitle">Your order has been successfully received!</h2>
    </div>
</div>
<?php
$pixl = array (
